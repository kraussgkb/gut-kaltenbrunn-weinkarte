...
if(!document.querySelector('script[data-wf-pairing-icons]')){const p=document.createElement('script');p.src='pairing-icons.js?v=6';p.defer=true;p.dataset.wfPairingIcons='1';document.head.appendChild(p)}
})();
